...
<body class="body-login bg-secondary" style="height:100vh;">
  <!-- NAVBAR -->
  <nav class="navbar bg-secondary shadow-lg" style="flex-wrap: nowrap">
          ...
          <main class="form-signin w-100 m-auto">
            ...
            <form id="form" action="login.php" method="post">
              <div class="form-floating" style="margin-top: 1rem">
                <input type="email" class="form-control form-adm" id="floatingInput" placeholder="name@example.com" name="email" />
                <label for="floatingInput">Email</label>
              </div>

              <div class="form-floating" style="margin-top: 1rem">
                <input type="password" class="form-control form-adm" id="floatingPassword" placeholder="Password" name="senha" />
                <label for="floatingPassword">Senha</label>
              </div>

              <button class="w-100 btn btn-lg btn-secondary" style="margin-top: 1rem" type="submit">
                Entrar
              </button>
            </form>
          </main>
